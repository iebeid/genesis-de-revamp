package com.i3akef.genesis.runtime;
...
public class Quote {
    ...
    public static String message[][] = new String[][]{
        ...
        },
        {
            ...
            "temperance even than unintellectual sensuality; it strikes at the root of",
            "all domestic happiness, and consigns more than half of the human race to",
            "misery.",
            "Shelley"
        },
        {
            "HYPOCRITE, n. One who, professing virtues that he does not respect, secures",
            "the advantage of seeming to be what he depises.",
            "Ambrose Bierce (1842-1914), The Devil's Dictionary, 1911"
        },
        {
        ...
        {
            "SORCERY, n. The ancient prototype and forerunner of political influence. It",
            "was, however, deemed less respectable and sometimes was punished by torture",
            "and death. Augustine Nicholas relates that a poor peasant who had been",
            "accused of sorcery was put to the torture to compel a confession. After",
            "enduring a few gentle agonies the suffering simpleton admitted his guilt,",
            "but naively asked his tormentors if it were not possible to be a sorcerer",
            "without knowing it.",
            "Ambrose Bierce (1842-1914), The Devil's Dictionary, 1911"
        },
        {
        ...
        {
            "If you would attain to what you are not yet, you must always be displeased",
            "by what you are. For where you are pleased with yourself there you have",
            "remained. Keep adding, keep walking, keep advancing.",
            "Saint Augustine"
        },
        {
            "The world is governed more by appearance than realities so that it is fully",
            "as necessary to seem to know something as to know it.",
            "Webster"
        },
        {
            "It's our fault. We should have given him better parts.",
            "Jack Warner, on hearing that Ronald Reagan had been elected governor of",
            "California"
        },
        {
        ...
        {
            "In films murders are always very clean. I show how difficult it is and what",
            "a messy thing it is to kill a man.",
        ...
        {
            "Spare minutes are the Gold-dust of time; the portions of life most fruitful",
            "in good and evil; the gaps through which temptations enter.",
            "Author Unknown"
        },
        {
            "The mistakes are all there waiting to be made.",
            "Chessmaster Savielly Grigorievitcyh Tartakower (1887-1956) on the game's",
            "opening position."
        },
        {
            "The worst thing about Europe is that you can't go out in the middle of the",
            "night and get a Slurpee.",
            "Tellis Frank"
        },
        {
        ...
        {
            "QUILL, n. An implement of torture yielded by a goose and commonly wielded by",
            "an ass. This use of the quill is now obsolete, but its modern equivalent,",
        ...
        {
            "You've decided to love me for eternity and I'm still deciding who I want to",
            "be today.",
            "Ani Defranco"
        },
        {
            "Plumpick: Don't you understand, the whole town will blow up in three",
            "minutes!",
        ...
        {
            "At the Cole School, where they had community singing every morning the",
            "teacher noticed that Jack London remained silent. She asked him why. He",
            "replied that she didn't know how to sing, that she would spoil his voice",
            "because she flatted. The teacher dispatched him to the principal to be",
            "punished. The principal sent him back with a note saying that he could be",
            "excused, but that he would have to write a composition each morning for",
            "fifteen minutes of singing. Jack ascribes his ability to write a thousand",
            "words every morning to the habit formed in this class.",
            "Irving Stone"
        },
        {
        ...
        },
        {
            ...
            "rejoice at what bring you nothing but misfortune. Our nervous system isn't",
            "just a fiction, it's part of our physical body, and our soul exists in space",
            "and is inside us, like teeth in our mouth. It can't be forever violated with",
            "impunity.",
            "Boris Pasternak, Doctor Zhivago"
        },
        {
            "HANDKERCHIEF, n. A small square of silk or linen, used in various ignoble",
            "offices about the face and especially serviceable at funerals to conceal the",
            "lack of tears. The handkerchief is of recent invention; our ancestors knew",
            "nothing of it and intrusted its duties to the sleeve. Shakespeare's",
            "introducing it into the play of Othello is an anachronism: Desdemona dried",
            "her nose with her skirt, as Dr. Mary Walker and other reformers have done",
            "with their coattails in our own day -- an evidence that revolutions",
        ...
        {
            "I may not agree with what you say, but I'll fight to the death for your",
        ...
        },
        {
            ...
            "soul abhors a vacuum and they have not discovered any continuous employment",
            "for man's nobler faculties.",
            "Henry David Thoreau"
        },
        {
        ...
        {
            "I never lecture, not because I am shy or a bad speaker, but simply because I",
        ...
        {
            "The term learning disability has appeal because it implies a specific",
            "neurological condition for which no one can be held particularly",
            "responsible, and yet it escapes the stigma of mental retardation. There is",
            "no implication of neglect, emotional disturbance, or improper training or",
            "education, nor does it imply a lack of motivation on the part of the child.",
        ...
        },
        {
            ...
            "gods, helping them once or twice using a particularly nasty form of",
            "trickery. He was a cunning negotiator with a talent for technicalities. He",
            "was sort of the Norse equivalent of a lawyer, no doubt the reason they tied",
            "him down in a pit dripping acidic venom on him.",
            "Martin Terman"
        },
        {
        ...
        {
            "The ocean is a body of water occupying about two-thirds of a world made for",
        ...
        {
            "All say, 'How hard it is to die' - a strange complaint to come from the",
        ...
        },
        {
            ...
            "And however futile each individual act of courage or generosity,",
            "self-sacrifice or grace-it still proves the thing exists. Each act adds to",
            "the fund. It needs replenishment. Not only because evil flourishes, and is,",
            "most indefensibly, defended. But because goodness is no longer a respectable",
            "aim in life. The hound of hell, envy, has driven it from the house.",
            "Josephine Hart, Sin"
        },
        {
            "One kernel is felt in a hogshead; one drop of water helps to swell the",
            "ocean; a spark of fire help to give light to the world. None are too small,",
        ...
        {
            "Critics are like eunuchs in a harem; they know how its done, they've seen it",
        ...
        },
        {
            ...
            "Last words of Spanish playwright Lope de Vega on being assured on his",
            "deathbed that the end was very near"
        },
        {
            "He for himself weaves woe who weaves for others woe, and evil counsel on the",
            "counselor recoils.",
            "Hesiod"
        },
        {
        ...
        {
            "Bah! Doom need not phrase his answer in the form of a question.",
            "Dr. Doom"
        },
        {
            "There are days when solitude, for someone my age, is a heady wine that",
            "intoxicates you with freedom, others when it is a bitter tonic, and still",
            "others when it is a poison that makes you beat your head against the wall.",
        ...
        {
            "Mine! Gimme!",
            "Sammuel, Former Seeker of Truth"
        },
        {
            "Anyone who works is a fool. I don't work - I merely inflict myself upon the",
            "public.",
            "Robert Morley"
        },
        {
        ...
        {
            "Every oak tree started out as a couple of nuts who decided to stand their",
            "ground.",
            "Unknown"
        },
        {
            "We are Microsoft. Lower your antiviruses and surrender your hard drives. We",
            "will add your technological and biological distinctiveness to our own.",
        ...
        {
            "It is the saying of an ancient sage that humor was the only test of gravity,",
            "and gravity of humor.",
            "Shaftesbury"
        },
        {
            "And I looked, and behold a pale horse: and his name that sat upon him Death,",
        ...
        },
        {
            ...
            "thy Holy Hand Grenade of Antioch toward thy foe, who being naughty in my",
            "sight, shall snuff it.",
            "Brother Maynard reading from the book of Armaments"
        },
        {
        ...
        {
            "What is fame? The advantage of being known by people of whom you yourself",
            "know nothing, and for whom you care as little",
            "Stanislaus"
        },
        {
        ...
        {
            "Milk is the root of all evil. Every murderer, rapist, and thief in the world",
            "started out on milk.",
            "Larry Gwaltney"
        },
        {
            "Man has made some machines that can answer questions provided the facts are",
            "profusely stored in them, but we will never be able to make a machine that",
            "will ask questions. The ability to ask the right question is more than half",
            "the battle of finding the answer.",
            "Thomas J. Watson"
        },
        {
            "If I traveled to the end of the rainbow As Dame Fortune did intend, Murphy",
            "would be there to tell me The pot's at the other end.",
            "Bert Whitney"
        },
        {
            "Do you realize the responsibility I carry? I'm the only person standing",
            "between Nixon and the White House.",
            "John F. Kennedy (1917 - 1963), as given in A. Schlesinger Jr's, A Thousand",
            "Days"
        },
        {
        ...
        {
            "A wise man will make haste to forgive, because he knows the full value of",
        ...
        },
        {
            ...
            "your life. Nothing looks more stupid than a hat.",
            "P. J. O'Rourke"
        },
        {
        ...
        {
            "Thus do the Gods make a mockery of the plans of Mice and Men.",
            "Unknown"
        },
        {
        ...
        },
        {
            ...
            "thinks he can never speak enough, may easily speak too much. A full tongue",
            "and an empty brain are seldom parted.",
            "Francis Quarles (My curse I'm afraid...sigh)"
        },
        {
        ...
        {
            "Damn the Torpedoes, full speed ahead I always say.",
            "P. Opus  Bloom County"
        },
        {
        ...
        {
            "Facts and the truth are often not interchangeable.",
            "Sho Pi"
        },
        {
        ...
        },
        {
            ...
            "evil.",
            "Plato (428 BC - 348 BC), Dialogues, Phaedo"
        },
        {
        ...
        {
            "I have forgotten the face of my father Gunslinger, and I cry your pardon.",
            "Eddie Dean"
        },
        {
        ...
        {
            "ENTERTAINMENT, n. Any kind of amusement whose inroads stop short of death by",
            "injection.",
            "Ambrose Bierce (1842 - 1914), The Devil's Dictionary"
        },
        {
            "A friend is a person who listens to me even when she isn't particularly",
            "interested in what I'm saying. She listens because she sees",
